...
struct BlockMN {
    ...
    cute::tuple<int, int> get_n_block_min_max(
            ...
            cutlass::FastDivmod const& qhead_per_khead_divmod, flash::AttnType const attn_type=flash::AttnType::Full) {
    ...
    cute::tuple<int, int> get_n_block_k_new_min_max(
            ...
            int const m_block, int const bidb, int const split_idx, int const num_splits,
            int const window_size_left, int const window_size_right,
            cutlass::FastDivmod const& qhead_per_khead_divmod, bool const is_causal) {
    ...
    cute::tuple<int, int> get_m_block_min_max(
            ...
            int const window_size_left, int const window_size_right, int const sink_token_length, flash::AttnType const attn_type) {
