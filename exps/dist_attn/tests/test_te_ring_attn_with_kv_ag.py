...
class TestTERingAttnWithKVAG(DistTestBase):
    ...
    def test_full_attn(self):
        ...
        te_ring_attn_with_KV_AG = TERingAttnWithKVAG(
            global_q,
            global_k,
            global_v,
            q_ranges,
        ...
        local_q = te_ring_attn_with_KV_AG.dispatch(
            global_q,
            rank,
            self.world_size,
            self.process_group,
        ...
        local_k = te_ring_attn_with_KV_AG.dispatch(
            global_k,
            rank,
            self.world_size,
            self.process_group,
        ...
        local_v = te_ring_attn_with_KV_AG.dispatch(
            global_v,
            rank,
            self.world_size,
            self.process_group,
        ...
        te_ring_attn_with_KV_ag_output = te_ring_attn_with_KV_AG.apply_attn(
            local_q,
            local_k,
            local_v,
            q_ranges,
        ...
        te_total_output = te_ring_attn_with_KV_AG.undispatch(
            te_ring_attn_with_KV_ag_output,
            rank,
            self.world_size,
            self.process_group,
            qkv_format="thd",
        ...
        te_global_grad_q = self.get_global_grad(
            te_ring_attn_with_KV_AG, global_q.grad, rank, attention_mask, "thd", "q"
        )
        te_global_grad_k = self.get_global_grad(
            te_ring_attn_with_KV_AG, global_k.grad, rank, attention_mask, "thd", "k"
        )
        te_global_grad_v = self.get_global_grad(
            te_ring_attn_with_KV_AG, global_v.grad, rank, attention_mask, "thd", "v"
        )
